...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2023 at 09:47 AM
...
--
-- Table structure for table `tb_produkkeluar`
--

CREATE TABLE `tb_produkkeluar` (
...
--
-- Dumping data for table `tb_produkkeluar`
--

INSERT INTO `tb_produkkeluar` (`id_suratkeluar`, `no_suratkeluar`, `lampiran`, `tujuan_surat`, `kode_klasifikasi`, `kepada`, `perihal`, `isi_surat`, `tgl_surat`, `tgl_keluar`, `file_suratkeluar`, `ket_suratkeluar`) VALUES
...
--
-- Table structure for table `tb_produkmasuk`
--

CREATE TABLE `tb_produkmasuk` (
  `id_suratmasuk` int(11) NOT NULL,
...
--
-- Dumping data for table `tb_produkmasuk`
--

INSERT INTO `tb_produkmasuk` (`id_suratmasuk`, `no_suratmasuk`, `no_agenda`, `asal_surat`, `kode_klasifikasi`, `isi_surat`, `tgl_surat`, `tgl_diterima`, `file_suratmasuk`, `ket_suratmasuk`) VALUES
...
--
-- Indexes for table `tb_produkkeluar`
--
ALTER TABLE `tb_produkkeluar`
  ADD PRIMARY KEY (`id_suratkeluar`);

--
-- Indexes for table `tb_produkmasuk`
--
ALTER TABLE `tb_produkmasuk`
...
--
-- AUTO_INCREMENT for table `tb_produkkeluar`
--
ALTER TABLE `tb_produkkeluar`
  MODIFY `id_suratkeluar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT for table `tb_produkmasuk`
--
ALTER TABLE `tb_produkmasuk`
