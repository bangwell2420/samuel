        ...
        <div class="container py-5">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-5 col-md-9">
                    <div class="text-white text-center font-weight-bold" style="font-size: 60px;"><img src="data/logo.png" width="100" height="100"></i></div><br>
                    <h3 class="text-white text-center font-weight-bold">Sistem Informasi Penjualan Bubuk Jahe Di PT Nesva Pematang Raya</h3>
