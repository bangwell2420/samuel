...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="fa fa-folder-open"></i> Data Klasifikasi Produk</h1>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-info"><i class="fa fa-table"></i> Daftar Data Klasifikasi</h6>
    </div>
                            ...
                            <div class="modal-content">
								...
								<div class="modal-body">
									...
									?>                                    
										...
										<div class="form-group">
											<label class="font-weight-bold">Ukuran Klasifikasi</label>
