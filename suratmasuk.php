...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-file"></i> Data Produk Masuk</h1>
...
<div class="card shadow mb-4">
	<div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-info"><i class="fa fa-table"></i> Daftar Data Produk Masuk</h6>
    </div>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
				...
				<tbody>
					<?php
						$sql = mysqli_query($conn, "SELECT * FROM tb_produkmasuk");
						$no = 1;
						...
						<div class="modal fade" id="hapus<?php echo $row['id_suratmasuk']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">Pilih "Hapus" untuk menghapus data produk <?= $row['no_suratmasuk'] ?>.</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label class="font-weight-bold">Nomor Produk Masuk</label>
													...
													<div class="form-group">
														<label class="font-weight-bold">Asal Produk</label>
												...
												<div class="col-md-6">
													...
													<div class="form-group">
														<label class="font-weight-bold">Tanggal Produk</label>
